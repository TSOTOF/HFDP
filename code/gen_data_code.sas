...
proc export data = work.table2005_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2005.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2006_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2006.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2007_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2007.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2008_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2008.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2009_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2009.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2010_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2010.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2011_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2011.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2012_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2012.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2013_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2013.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2014_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2014.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2015_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2015.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2016_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2016.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2017_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2017.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2018_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2018.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2019_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2019.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2020_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2020.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2021_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2021.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2022_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2022.csv'
    dbms = csv replace;
run;
...
proc export data = work.table1999M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF1999M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2000M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2000M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2001M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2001M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2002M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2002M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2003M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2003M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2004M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2004M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2005M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2005M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2006M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2006M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2007M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2007M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2008M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2008M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2009M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2009M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2010M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2010M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2011M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2011M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2012M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2012M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2013M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2013M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2014M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2014M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2015M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2015M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2016M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2016M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2017M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2017M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2018M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2018M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2019M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2019M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2020M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2020M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2021M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2021M.csv'
    dbms = csv replace;
run;
...
proc export data = work.table2022M_list
    outfile = '../数据代码列表/原始逻辑库数据表代码/HF2022M.csv'
    dbms = csv replace;
run;
